...
<s:debug></s:debug>
${cookie }
<form action="${pageContext.request.contextPath}/system/userAction_login.action" method="post" >
					...
					<tr>
						...
						<td height="99" width="27%">
							<table border="0" width="70%" id="table4">
								<tr>
									<TD colspan="2"><span style="color:red"><s:actionerror/></span></TD>
								</tr>
								<tr>
									<td width="100"><img border="0" src="${pageContext.request.contextPath}/images/yonghu.jpg" width="84" height="20"></td>
									<td><input type="text" name="account" style="width: 100 px" value="${cookie.account.value }"  maxlength="25"></td>
	
								</tr>
								<tr>
									<td width="100"><img border="0" src="${pageContext.request.contextPath}/images/mima.jpg" width="84" height="20"></td>
									<td><input type="password" name="password" style="width: 100 px" value="${cookie.password.value }"  maxlength="25"></td>
								...
								<tr>
									...
									<td>
										<table>
											<tr>
												<td>
													<input type="text" name=checkCode id="checkCode" style="width: 40 px" value=""  maxlength="4">
												</td>
												<td>
													<img src="${pageContext.request.contextPath}/system/checkCodeAction.action" name="checkNumber" style="cursor:hand" title="点击可更换图片" height="20" onclick="this.src='${pageContext.request.contextPath}/system/checkCodeAction.action?timestamp='+new Date().getTime()"/>
												</td>
											</tr>
										</table>
									</td>
