...
<html>
	...
	<div style="width:90%;background-color: #f5fafe;">
		...
		<br/><br/>
		<form id="form1" action="${pageContext.request.contextPath }/workflow/taskAction_approve.action" method="post">
		...
		<table id="table"    style="width: 100%" cellspacing="0"   border="0">
					<tr>
						<td>查看申请文件</td>	
						<td align="left"><a href="${pageContext.request.contextPath }/workflow/taskAction_downloadApplyFile.action?taskId=<s:property value="%{#request.taskApply.taskId}"/>" >员工请假申请模板_张三.doc</a></td>				
					</tr>
					<tr>
						<td>当前任务名称</td>
