	...
	<div style="width:90%;background-color: #f5fafe;">
		...
		<div>
			...
			<div align="right" style="float: right;">
			    ...
			    <input  type="button" value="上传申请模板"  onclick="openWindow('${pageContext.request.contextPath }/workflow/applyTemplateAction_addPage.action','700','400')" />
			</div>
		...
		<table id="table"    style="width: 100%" cellspacing="0"  border="0">
			<thead style="height: 20px;">
				...
				<s:iterator value="%{#request.applyTemplateList}" var="applyTemplate">
					<tr>
							<td><s:property value="%{#applyTemplate.filename}"/></td>
							<td><s:property value="%{#applyTemplate.processDefinitionKey}"/></td>
							<td>
								<a href="${pageContext.request.contextPath}/workflow/applyTemplateAction_download.action?templateId=<s:property value="%{#applyTemplate.templateId}"/>">下载</a>
								<a href="${pageContext.request.contextPath}/workflow/applyTemplateAction_delete.action?templateId=<s:property value="%{#applyTemplate.templateId}"/>" onclick="return confirm('你确定要删除 员工请假申请模板.doc？')">
