...
<body>
		<form id="form1" action="${pageContext.request.contextPath }/workflow/applyTemplateAction_uploadTemplate.action" method="post" enctype="multipart/form-data">
			<br>
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
			        ...
			        <s:select name="processDefinitionKey" list="%{#request.processDefinitions}" listKey="key" listValue="key"></s:select>
			        <!-- 
			         	<select name="processDefinitionKey" id="processDefinitionKey" style="width:155px">
						    <option>员工请假流程</option>
						    <option>设备购置计划流程</option>
						    <option>设备费用报销流程</option>
						</select>
					 -->
	            	</td>
				</tr>
